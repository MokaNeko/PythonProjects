...
class HookEvent(object):
    ...
    '''
    def __init__(self, msg, time, hwnd):
...
class MouseEvent(HookEvent):
    ...
    '''
    def __init__(self, msg, x, y, data, flags, time, hwnd):
        '''Initializes an instance of the class.'''
        HookEvent.__init__(self, msg, time, hwnd)
        self.Position = (x,y)
        if data > 0: w = 1
        elif data < 0: w = -1
        else: w = 0
...
class KeyboardEvent(HookEvent):
    ...
    @type Ascii: string
    '''
    def __init__(self, msg, vk_code, scan_code, ascii, flags, time, hwnd):
...
class HookManager(object):
    ...
    def MouseSwitch(self, msg, x, y, data, flags, time, hwnd):
        '''
        ...
        @type hwnd: integer
        '''
        event = MouseEvent(msg, x, y, data, flags, time, hwnd)
